  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 font-body",
  {
    variants: {
      variant: {
        ...
        gold: "border-transparent bg-accent/10 text-accent-foreground border-accent/20",
        present: "border-transparent bg-success/10 text-success",
        absent: "border-transparent bg-destructive/10 text-destructive",
        late: "border-transparent bg-warning/10 text-warning-foreground",
        excused: "border-transparent bg-muted text-muted-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
